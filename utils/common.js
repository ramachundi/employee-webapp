...
function getFavoriteJoke() {
    return __awaiter(this, void 0, void 0, function () {
        var response, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, node_fetch_1.default("https://icanhazdadjoke.com", {
                        headers: {
                ...
                case 2:
                    ...
                    return [2 /*return*/, result.joke];
            }
        });
    });
}
exports.getFavoriteJoke = getFavoriteJoke;
function getFavouriteQuote() {
    return __awaiter(this, void 0, void 0, function () {
        var response, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, node_fetch_1.default("https://ron-swanson-quotes.herokuapp.com/v2/quotes")];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
